    ...
    <main>
      <header className="site-header" id="top">
        <nav className="shell nav" aria-label="Primary navigation">
          <a className="brand" href="#top" aria-label="LegacyBridge home">
            <img src="/legacybridge-logo.svg" alt="LegacyBridge" />
          </a>
          <div className="nav-menu">
            <a href="#benefit">The benefit</a>
            <a href="#privacy">Privacy</a>
            <a href="#pricing">Pricing</a>
            <a href="#faq">FAQ</a>
            <a className="nav-cta" href="#enquire">Corporate enquiry</a>
          </div>
        </nav>
      </header>
        ...
        <div className="shell hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="btn primary" href="#enquire">Get corporate pricing</a>
      ...
      <section className="pricing-section section-pad" id="pricing">
        <div className="shell pricing-grid">
          ...
          <div className="price-card">
            ...
            <a className="btn primary full" href="#enquire">Request a proposal</a>
      ...
      <section className="cta-section" id="enquire">
        <div className="shell cta-card">
          ...
          <div className="hero-actions center">
            <a className="btn light" href="https://www.legacybridge.in">Start a corporate enquiry</a>
            <a className="btn ghost" href="https://www.legacybridge.in">Visit legacybridge.in</a>
          </div>
        </div>
      </section>
      ...
      <footer className="site-footer">
        <div className="shell footer-grid">
          ...
          <div className="footer-links"><a href="#benefit">The benefit</a><a href="#privacy">Privacy</a><a href="#pricing">Pricing</a><a href="#faq">FAQ</a></div>
