      ...
      html: `
        <div style="font-family: sans-serif; padding: 25px; color: #1a150e; background-color: #faf7f0; border-radius: 12px; max-width: 600px; margin: 0 auto; border: 1px solid rgba(217, 184, 133, 0.25);">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${accessLink}" style="background-color: #b28e46; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 9999px; font-weight: bold; display: inline-block; font-size: 15px; box-shadow: 0 4px 6px -1px rgba(178, 142, 70, 0.4);">Access Decrypted Assets</a>
          </div>

          <p style="font-size: 13px; color: #6b5a45; line-height: 1.5;">If the button above does not work, please copy and paste the following link directly into your browser:</p>
          <p style="background-color: #ffffff; padding: 12px; border-radius: 8px; font-family: monospace; font-size: 12px; word-break: break-all; border: 1px solid rgba(217, 184, 133, 0.25); color: #5c4d3c; margin: 10px 0 25px;">${accessLink}</p>
